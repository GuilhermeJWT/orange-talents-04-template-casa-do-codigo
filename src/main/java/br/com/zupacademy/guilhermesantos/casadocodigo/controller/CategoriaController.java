...
import br.com.zupacademy.guilhermesantos.casadocodigo.exception.UniqueNomeCategoriaException;
...
public class CategoriaController {
    ...
    @Autowired
    private UniqueNomeCategoriaException uniqueNomeCategorialValidator;

    @InitBinder
    public void before(WebDataBinder before){
        before.addValidators(uniqueNomeCategorialValidator);
    }
